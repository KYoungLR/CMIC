...
public class MockPolicyWebServiceClient {
	...
	public List<CMICPolicyDTO> getPoliciesByPolicyNumbers(String[] combinedPolicyNumber) {
	...
	public List<CMICTransactionDTO> getTransactionsOnPolicy(String combinedPolicyNumber) {
