...
public interface MockCommissionDocumentWebServiceConfiguration {
	...
	@Meta.AD(
		deflt = "true", description = "Enable mock for Commission Document Service method /v1/download/ids",
		required = false
	)
	public boolean enableMockDownloadDocuments();

	@Meta.AD(
		deflt = "true", description = "Enable mock for Commission Document Service method /v1/search", required = false
	)
