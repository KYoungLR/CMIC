...
public interface MockPolicyDocumentWebServiceConfiguration {
	...
	@Meta.AD(
		deflt = "true", description = "Enable mock for Policy Document Service method /v1/download/transactions/recent",
		required = false
	)
	public boolean enableMockGetRecentTransactions();

	@Meta.AD(
		deflt = "true", description = "Enable mock for Policy Document Service method /v1/download/transactions",
		required = false
	)
	public boolean enableMockGetTransactions();
