...
public interface MockPortalUserWebServiceConfiguration {
	...
	@Meta.AD(deflt = "true", description = "Enable mock for Portal User Service method /v1/isUserRegistered", required = false)
	public boolean enableMockIsUserRegistered();

	@Meta.AD(deflt = "true", description = "Enable mock for Portal User Service method /v1/isUserValid", required = false)
	public boolean enableMockIsUserValid();

	@Meta.AD(deflt = "true", description = "Enable mock for Portal User Service method /v1/validateUser", required = false)
	public boolean enableMockValidateUser();

	@Meta.AD(deflt = "true", description = "Enable mock for Portal User Service method /v1/validateUserRegistration", required = false)
