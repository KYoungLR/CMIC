...
@Meta.OCD(
	description = "Configure settings for accessing API Gateway to Church Mutual REST Services.",
	id = "com.churchmutual.rest.configuration.CMICWebServiceAuthenticationConfiguration",
	localization = "content/Language", name = "church-mutual-web-service-authentication"
)
public interface CMICWebServiceAuthenticationConfiguration {
	...
	@Meta.AD(deflt = "", description = "Header Key")
	public String headerKey();

	@Meta.AD(deflt = "", description = "Header Value")
