...
public class CMICPolicyDocumentServiceScreenNavigationEntry extends BaseTestHarnessScreenNavigationEntry {
	...
	public List<HarnessDescriptor> getHarnessDescriptors() {
		...
		getRecentTransactionsDescriptor.setParameters(
			ListUtil.fromArray(accountNum, includeBytes, policyNum, policyType));
		...
		getTransactionsDescriptor.setParameters(
			ListUtil.fromArray(accountNum, includeBytes, policyNum, policyType, sequenceNum));
