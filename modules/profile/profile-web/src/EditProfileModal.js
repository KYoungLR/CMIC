...
function EditProfileModal(props) {
  ...
  >
    <ul className="list-unstyled">
      <li className="mb-4">
        <a href="#" target="_blank">{Liferay.Language.get('update-email')}</a>
        <ClayIcon spritemap={spritemap} symbol="shortcut" className="ml-2" />
      </li>
      <li className="mb-4">
        <a href="#" target="_blank">{Liferay.Language.get('update-profile-and-password')}</a>
        <ClayIcon spritemap={spritemap} symbol="shortcut" className="ml-2" />
      </li>
      <li>
        <a href="#" target="_blank">{Liferay.Language.get('configure-multi-factor-authentication')}</a>
        <ClayIcon spritemap={spritemap} symbol="shortcut" className="ml-2" />
      </li>
    </ul>
  </Dialog>;
