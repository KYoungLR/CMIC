...
public class AccountEntryPersistenceImpl
	 ...
	 */
	@Override
	public List<AccountEntry> findByName(
	 ...
	 */
	@Override
	public AccountEntry findByName_First(
	 ...
	 */
	@Override
	public AccountEntry fetchByName_First(
		String name, OrderByComparator<AccountEntry> orderByComparator) {
	 ...
	 */
	@Override
	public AccountEntry findByName_Last(
			String name, OrderByComparator<AccountEntry> orderByComparator)
		throws NoSuchEntryException {
	 ...
	 */
	@Override
	public AccountEntry fetchByName_Last(
		String name, OrderByComparator<AccountEntry> orderByComparator) {
		...
		List<AccountEntry> list = findByName(
	 ...
	 */
	@Override
	public AccountEntry[] findByName_PrevAndNext(
		...
		try {
			...
			array[0] = getByName_PrevAndNext(
				session, accountEntry, name, orderByComparator, true);

			array[1] = accountEntry;

			array[2] = getByName_PrevAndNext(
				session, accountEntry, name, orderByComparator, false);
	...
	protected AccountEntry getByName_PrevAndNext(
		Session session, AccountEntry accountEntry, String name,
		OrderByComparator<AccountEntry> orderByComparator, boolean previous) {
	...
	/**
	 * Returns all the account entries that the user has permission to view where name = &#63;.
	 *
	 * @param name the name
	 * @return the matching account entries that the user has permission to view
	 */
	@Override
	public List<AccountEntry> filterFindByName(String name) {
		return filterFindByName(
			name, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the account entries that the user has permission to view where name = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>AccountEntryModelImpl</code>.
	 * </p>
	 ...
	 */
	@Override
	public List<AccountEntry> filterFindByName(
		String name, int start, int end) {
	...
	/**
	 * Returns an ordered range of all the account entries that the user has permissions to view where name = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>AccountEntryModelImpl</code>.
	 * </p>
	...
	/**
	 * Returns the account entries before and after the current account entry in the ordered set of account entries that the user has permission to view where name = &#63;.
	 *
	 * @param accountEntryId the primary key of the current account entry
	 * @param name the name
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public AccountEntry[] filterFindByName_PrevAndNext(
			long accountEntryId, String name,
			OrderByComparator<AccountEntry> orderByComparator)
		throws NoSuchEntryException {

		if (!InlineSQLHelperUtil.isEnabled()) {
			return findByName_PrevAndNext(
	...
	protected AccountEntry filterGetByName_PrevAndNext(
		Session session, AccountEntry accountEntry, String name,
		OrderByComparator<AccountEntry> orderByComparator, boolean previous) {
	...
	/**
	 * Returns the number of account entries that the user has permission to view where name = &#63;.
	 *
	 * @param name the name
	 * @return the number of matching account entries that the user has permission to view
	 */
	...
	private static final String _FINDER_COLUMN_NAME_NAME_3 =
		"(accountEntry.name IS NULL OR accountEntry.name = '')";
